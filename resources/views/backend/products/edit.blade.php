                    ...
                    <div class="card-body">
                        <div class="row">
                                    ...
                                    <select name="sub_category_id" class="form-select" id="sub_category">
                                        ...
                                        @foreach ($subCategories as $subcategory)
                                            <option value="{{ $subcategory->id }}"
                                                {{ $editProduct->sub_category_id == $subcategory->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div>
                                    <input type="text" class="form-control @error('product_code') is-invalid @enderror"
                                        ...
                                        value="{{ old('product_code', $editProduct->product_code) }}">
                                    @error('product_code')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div>
                                    <input type="text" class="form-control @error('product_name') is-invalid @enderror"
                                        ...
                                        value="{{ old('product_name', $editProduct->product_name) }}">
                                    @error('product_name')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div>
                                    <select name="status" class="form-select">
                                        <option value="1"
                                            {{ old('status', $editProduct->status) == '1' ? 'selected' : '' }}>Active
                                        </option>
                                        <option value="0"
                                            {{ old('status', $editProduct->status) == '0' ? 'selected' : '' }}>Inactive
                                        </option>
                                    </select>
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <textarea id="tinymce-mytextarea" name="description" value="{{ old('description') }}"
                                    placeholder="Write a decsription for the product..."> {{ old('description', $editProduct->description) }} </textarea>
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3 text-center">
                                ...
                                <div>
                                    @if ($editProduct->product_image)
                                        <img src="{{ asset('images/' . $editProduct->product_image) }}"
